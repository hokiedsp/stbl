function params = fit(X,varargin)
%STBL.FIT   Estimate alpha-stable parameters
%   PARAMS = STBL.FIT(X) returns an estimate of the four parameters in a
...
%   location DELTA.
%
%   PARAMS = STBL.FIT(X,METHOD) Specifies the algorithm used to
%   estimate the parameters.  The choices for METHOD are
%
%       'ecf'        - Fits the four parameters to the empirical
%                      characteristic function estimated from the data.
%                      This is the default. Based on Koutrouvelis (1980,
%                      1981), see [1,2] below.
...
%                      accurate in general. Based on McCulloch (1986), see
%                      [2] below.
%
%   PARAMS = STBL.FIT(...,OPTIONS) specifies options used in STBLFIT.
%   OPTIONS must be an options stucture created with the STATSET function.
...
%                  0.01.
%
%   See also: STBL.RND, STBL.PDF, STBL.CDF, STBL.INV
