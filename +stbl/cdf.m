function F = cdf(x,alpha,beta,gam,delta,varargin)
%F = STBL.CDF(X,ALPHA,BETA,GAM,DELTA) returns the cdf of the stable 
...
% 
%P = STBL.CDF(X,ALPHA,BETA,GAM,DELTA,TOL) computes the cdf to within an
...
%
% See also: STBL.RND, STBL.PDF, STBL.INV
%  
% References:
%
% [1] J. P. Nolan (1997)
